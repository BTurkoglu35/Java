...
public class C04_Overloading {
    public static void main(String[] args) {
        ...
        topla(5.2, 3); // 8.2
        topla(3.4, 6.1); // 9.5
        topla(5,6.2);//11.2  3.kod calisir.int double a sigdigi icin .
    }

    // Java hangi methodaun calisagina karar verirken optimizasyon yapar
    ...
    // kullanbilecegi methodu tercih eder
