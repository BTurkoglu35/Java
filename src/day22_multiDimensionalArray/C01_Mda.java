...
public class C01_Mda {
    public static void main(String[] args) {
       ...
       her non  primitive data direk yazdiralamayabilr


       ancak array'in icreisindeki elementleri direk yazdirabiliyorduk
       cunku genelde primitive data turu veya string elemntler kullaniiliyordu
